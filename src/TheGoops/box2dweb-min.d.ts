...
module Box2D.Dynamics.Joints {
	...
	**/
	export class b2PulleyJointDef extends b2JointDef {
		...
		* @param anchorB Anchor B.
		**/
		public Initialize(bA: b2Body, bB: b2Body, gaA: b2Math.b2Vec2, gaB: b2Math.b2Vec2, anchorA: b2Math.b2Vec2, anchorB: b2Math.b2Vec2, ratio: number): void;
	}
}
